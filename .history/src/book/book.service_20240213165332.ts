...
export class BookService {
  ...
  async create(bookData: CreateBookDto, user: any): Promise<Book> { // Now accepts two parameters
    const createdBook = new this.bookModel({
      ...bookData,
      user: user._id, // Assuming you want to store the user's ID in the book document
    });
